            ...
            <div class="border-b border-border bg-card">
                <div class="mx-auto flex max-w-5xl items-center justify-between px-4 py-3">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="/admin" onclick="event.preventDefault(); window.location.href='/admin.html';" title="View Saved Submissions" class="text-xs font-semibold px-2.5 py-1.5 rounded-lg bg-secondary text-secondary-foreground hover:bg-primary hover:text-white transition">
                            Admin JSON
                        </a>
